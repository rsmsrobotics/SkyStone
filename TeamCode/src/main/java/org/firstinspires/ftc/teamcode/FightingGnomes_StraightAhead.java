...
@Autonomous(name="Fighting Gnomes Straight Ahead", group="Linear Opmode")
//@Disabled
public class FightingGnomes_StraightAhead extends LinearOpMode {
...
*/
        ...
        this.robot.mecanumDrive(0, FORWARD_SPEED, 0);
...
/*
       ...
       // this.robot.mechanismControl(0.0, -0.0, 0,-0.5  );
        ...
        this.robot.mecanumDrive(0, BACKWARD_SPEED, 0.0);
        runtime.reset();
        while (opModeIsActive() && (runtime.seconds() < 3.0)) {
            telemetry.addData("Path", "Leg 3: %2.5f S Elapsed", runtime.seconds());
            telemetry.update();
        }
        this.robot.mecanumDrive(0, 0, 0.0);
