...
@Autonomous(name="Fighting Gnomes Auto Mode NOOP", group="Linear Opmode")
//@Disabled
public class FightingGnomes_AutoMode_NOOP extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        /* This code does not do anything in Autonomous Mode

        // Step through each leg of the path, ensuring that the Auto mode has not been stopped along the way

        // Step 1:  lower robot for 3 seconds
        this.robot.mechanismControl(1.0, -0.0, 0 );
        ...
        this.robot.mechanismControl(0,0,0);
